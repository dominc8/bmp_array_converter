...
void bitmap_parser_wrong_file_header(void)
{
    ...
    int32_t ret_val = bitmap_parse_headers(&bitmap, &bitmap_mem[0]);
    CU_ASSERT_NOT_EQUAL(ret_val & BITMAP_FH_MASK, BITMAP_OK);
    CU_ASSERT_EQUAL(ret_val & BITMAP_BH_MASK, BITMAP_OK);
}
...
void bitmap_parser_wrong_bitmap_header(void)
{
    ...
    int32_t ret_val = bitmap_parse_headers(&bitmap, &bitmap_mem[0]);
    CU_ASSERT_NOT_EQUAL(ret_val & BITMAP_BH_MASK, BITMAP_OK);
    CU_ASSERT_EQUAL(ret_val & BITMAP_FH_MASK, BITMAP_OK);
}
